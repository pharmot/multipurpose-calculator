...
![Intranet version](https://img.shields.io/static/v1?label=intranet&message=v1.2.2&color=%2355a63a&logo=windowsxp)&nbsp;&nbsp;&nbsp;
...
- Add support for black & white printing

## [1.2.3] - 2024-05-03

### Changed
- PCA max accumulated dose per 1 hour for all therapies
- PCA pump limits updated to match new smart pumps
